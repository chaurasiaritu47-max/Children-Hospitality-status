...
<style>
.stApp {
    background-color: #121212;     /* light beige background */
}
h1 {   
    color: #3F7BD6;     \* dark brown title color */
    font-weight: 700;
    font-size: 36px;
    text-align: center;        
}
...
[data-testid="stSidebar"] {
    background-color: #0A192F;    /* coffee brown sidebar */
}
...
[data-testid="stMetricLabel"] {
    color: #5E195E !important;            /* dark brown kpi labels */
...
label[data-testid="stWidgetLabel"] {
    color: #00FFFF !important;   /* 🔥 change color here */
    font-weight: bold;
}
